...
final class ElasticsearchAggregationCodableTests: XCTestCase {
    ...
    func testSingleValueResponse_response() throws {
        ...
        let response = try decoder.decode([String: AnyAggregationResponse<Int>].self, from: json.data(using: .utf8)!)
    ...
    func testNestingAggregations_encodesCorrectly() throws {
        let json = """
            {"aggs":{"terms_1":{"terms":{"field":"field1","size":10,"order":[{"terms_2":"desc"},{"terms_3":"desc"}]},"aggs":{"terms_2":{"terms":{"field":"terms2","size":4},"aggs":{"top_hits_aggs":{"top_hits":{"size":1}}}},"terms_3":{"max":{"field":"terms3"}}}}},"size":0,"from":0}
            """
      let searchContainer = SearchContainer(aggs:
        [
          TermsAggregation(
            ...
            size: 10,
            multiOrder: [
              ["terms_2" : SortOrder.descending],
              ["terms_3" : SortOrder.descending]
            ],
            aggs: [
              TermsAggregation(
                name: "terms_2",
    ...
    static var allTests = [
        ...
        ("testNestingAggregations_encodesCorrectly", testNestingAggregations_encodesCorrectly),
